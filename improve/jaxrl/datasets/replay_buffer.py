...
from improve.jaxrl.datasets.dataset import Dataset
...
class ReplayBuffer(Dataset):
    ...
    def initialize_with_dataset(self, dataset: Dataset, num_samples: Optional[int]):
        desc = "Can insert a batch online in an empty replay buffer."
        assert ( self.insert_index == 0), desc
        ...
        desc = "Dataset cannot be larger than the replay buffer capacity."
        assert ( self.capacity >= num_samples), desc
