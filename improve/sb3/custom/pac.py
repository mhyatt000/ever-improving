...
from improve.sb3.custom.semioffline import SemiOfflineAlgorithm

SelfPAC = TypeVar("SelfPAC", bound="PAC")


class PAC(SemiOfflineAlgorithm):
    """
    Perciever Actor-Critic (PAC)
    ...
    def __init__(
        ...
        env: Optional[GymEnv],  # environment
    ):
        super().__init__(algocn, modelcn, optimcn, traincn, env)
