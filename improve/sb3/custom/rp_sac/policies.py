...
@dataclass
class MultiInputPolicy_CN(SACPolicy_CN):
...
class MultiInputPolicy(SACPolicy):
    ...
    # def __init__(self, cn: MultiInputPolicy_CN = MultiInputPolicy_CN()):
    def __init__(
        self,
        observation_space: spaces.Space,
        action_space: spaces.Box,
    ...
    def predict(
        ...
        if deterministic:
            ...
            observation['agent_partial-action'] = fm_act
            del observation['simpler-img']
        ...
        if deterministic:
            # combine after squashing or not
            actions = self.rescaler.compute_final_action(actions, fm_act)
