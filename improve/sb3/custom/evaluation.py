...
def evaluate_policy(
    ...
    if logger is not None:
        logger.record("stats/actions/x", wandb.Histogram(actions[:, 0]))
        logger.record("stats/actions/y", wandb.Histogram(actions[:, 1]))
        logger.record("stats/actions/z", wandb.Histogram(actions[:, 2]))
        logger.record("stats/actions/roll", wandb.Histogram(actions[:, 3]))
        logger.record("stats/actions/pitch", wandb.Histogram(actions[:, 4]))
